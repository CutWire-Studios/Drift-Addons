...
// --- upstream: squareswire.glsl ---
// Author: gre
// License: MIT

uniform float p_squares_x;
uniform float p_squares_y;
#define squares ivec2(int(p_squares_x), int(p_squares_y))
uniform float p_direction_x;
uniform float p_direction_y;
#define direction vec2(p_direction_x, p_direction_y)
