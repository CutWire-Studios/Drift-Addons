...
uniform float p_fromStep_x;
uniform float p_fromStep_y;
uniform float p_fromStep_z;
uniform float p_fromStep_w;
#define fromStep vec4(p_fromStep_x, p_fromStep_y, p_fromStep_z, p_fromStep_w)
uniform float p_toStep_x;
uniform float p_toStep_y;
uniform float p_toStep_z;
uniform float p_toStep_w;
#define toStep vec4(p_toStep_x, p_toStep_y, p_toStep_z, p_toStep_w)
